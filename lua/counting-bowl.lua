...
validCountItemList = {
    -- space marines
    ["Power Glove + Power Sword"] = 10,
    ["Bold Pistol + Power Axe"] = 10,
    ["Heavy Bolter"] = 10,
    ["Missile Launcher"] = 10,
    ["Assault Cannon"] = 10,
    ["Plasma Gun"] = 10,
	...
	-- scout marines
    ["Scout Commander"] = 10,
    ["Scout Heavy Bolter"] = 10,
    ["Scout Combat Knife"] = 5,
	-- terminator marines
    ["Terminator Commander"] = 10,
    ["Terminator Assault Cannon"] = 10,
    ["Terminator Heavy Flamer"] = 10,
    ["Terminator Claws"] = 5,
    ["Terminator Thunderhammer & Shield"] = 5,
    ["Terminator Bolter & Powerfist"] = 5,
    ["Librarian"] = 10,
	-- eldar marines
    ["Eldar Exarch"] = 10,
    ["Eldar Las-Cannon"] = 10,
    ["Eldar Missile Launcher"] = 10,
    ["Eldar Shuriken Cannon"] = 10,
    ["Eldar Shuriken Catapult"] = 5,
	-- ork marines
    ["Nob Plasma Pistol"] = 10,
    ["Nob Boltpistol and Power Sword"] = 10,
    ["Nob Powerclaw and Chain Sword"] = 10,
    ["Ork Heavy Plasma"] = 10,
    ["Ork Marine"] = 5,
	-- tokens
    ["Primary Mission Token"] = 30,
    ["Secondary Mission Token"] = 15,
    -- aliens
    ["Gretchin"] = 2,
    ["Ork"] = 3,
    ["Chaos Commander"] = 10,
    ["Chaos Missile Launcher"] = 5,
    ["Chaos Marine"] = 5,
    ["Android"] = 10,
    ["Dreadnought"] = 25,
    ["Dreadnought MK VII"] = 25,
    ["Dreadnought MK VIII"] = 30,
    ["Dreadnought MK IX"] = 40,
    ["Dreadnought MK X"] = 50,
    ["Genestealer"] = 0,
	-- hybrids and tyranids
    ["Genestealer Hybrid "] = 0,
    ["Hybrid"] = 0,
    ["Hybrid with Autocannon"] = 0,
    ["Hybrid with Missile Launcher"] = 0,
    ["Hybrid with Beamer"] = 0,
    ["Tyranid Warrior Deathspitter"] = 10,
    ["Tyranid With Boneswords"] = 10,
}
